...
public class Constant {
	...
	public final static List<String> listOFStatiesCode = new ArrayList<>(mapOfUSStates.keySet());
	public final static List<String> listOFStatiesName = new ArrayList<>(mapOfUSStates.values());
}
